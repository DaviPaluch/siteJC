...
const informations = [
    ...
    'text': 'O ensaio por líquido penetrante é um método de teste não destrutivo que não prejudica as amostras ou peças que estão sendo inspecionadas. O teste é muito eficaz na detecção de rachaduras, fraturas, fissuras e outras falhas que estão abertas na superfície do corpo de prova e podem ser causadas por fadiga, impacto, têmpera, usinagem, retificação, forjamento, rajadas, retração ou sobrecarga.', 
    'bulletsText': []},
    ...
    'text': 'A medição de espessura por ultrassom é um método de avaliação de espessuras em materiais ferrosos e não ferrosos, paredes, chapas, tubos, tanques, vasos de pressão, entre outros. O método visa detectar perdas de espessuras nesses materiais, em razão de corrosões e processos abrasivos.', 
    'bulletsText': []},
    {'tittle': 'ANÁLISE DE RUÍDO AMBIENTAL',
    'photo':'../image/ruido.png', 
    'text': 'Este é um registro técnico que certifica os resultados obtidos em medições de ruído, com o objetivo de avaliar se os níveis sonoros encontrados em determinada área, independentemente de haver ou não queixas. Para isso, são comparados com os parâmetros legais e os limites permitidos de ruído estabelecidos pela norma NBR ABNT 10.151:2019.', 
    'bulletsText': ['ABNT NBR 10151']},
    {'tittle': 'NR 12',
    'photo':'../image/nr12.png', 
    'text': 'A NR 12 é essencial para garantir a segurança dos trabalhadores que lidam com máquinas e equipamentos no ambiente de trabalho. Sua conformidade é obrigatória e evita possíveis multas e sanções legais. Conte com nossos serviços especializados em segurança do trabalho para estar sempre em dia com a NR 12 e proteger seus colaboradores.', 
    'bulletsText': []},
    {'tittle': 'NR 11',
